...
from ecommerce_service_v2 import Order, process_complete_order
from feature_gate import create_customer_segment
...
def start_runtime_instrumentation() -> None:
    ...
    try:
        ...
        runtimespy.init(
            source=["mock-service"],
            skip_modules=["runtimespy.*", "mock_service.server", "mock_service.workloads"],
